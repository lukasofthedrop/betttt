...
class AdminPanelProvider extends PanelProvider
{
    ...
    {
        return auth()->check() && auth()->user()->hasRole('admin'); // Controla o acesso total à página
    }
    
    public static function canView(): bool
    {
        return auth()->check() && auth()->user()->hasRole('admin'); // Controla a visualização de elementos específicos
    }
    /** 
     * @param Panel $panel
     * @return Panel
